...
export function ProfileCard({ profileData, assessmentHistory, onRunAnalysis, onEdit, onViewInsights, onAvatarUpload, isOwnProfile }: ProfileCardProps) {
  ...
  return (
      <div className="w-full h-full rounded-3xl border border-white/10 bg-card/60 p-6 shadow-2xl backdrop-blur-xl dark:border-white/20 dark:bg-black/40 flex flex-col gap-6">
